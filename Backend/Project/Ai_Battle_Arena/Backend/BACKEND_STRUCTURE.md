...
| File | Purpose |
|------|---------|
| `models/user.model.js` | User schema with email and password |
| `controller/authController.js` | Register, login, logout logic |
| `routes/auth.routes.js` | POST `/auth/register`, `/auth/login`, `/auth/logout` |
