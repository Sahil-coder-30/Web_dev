...
const DUMMY_HIGHLIGHTS = [
    {
        id: 1,
        name: "Travel",
        cover: "https://images.unsplash.com/photo-1542314831-c53cd4185af1?w=150&q=80",
    },
    {
        id: 2,
        name: "Design",
        cover: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=150&q=80",
    },
    {
        id: 3,
        name: "Sunsets",
        cover: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=150&q=80",
    },
    {
        id: 4,
        name: "Food",
        cover: "https://images.unsplash.com/photo-1511895426328-dc8714191300?w=150&q=80",
    },
];
            ...
            <main className="profile-main">
                    ...
                    <div className="profile-header__info">
                        ...
                        <div className="profile-header__username-row">
                            <div className="profile-header__name-group">
                                <h2 className="profile-header__username-text">{USER.fullName}</h2>
                                <span className="profile-header__username-sub">@{USER.username}</span>
                            </div>
                            <VisitorActions
                ...
                {activeTab === "posts" && (
                    <section className="post-grid">
                        {postsLoading && <p style={{ padding: "1rem", color: "var(--text-sub)" }}>Loading posts...</p>}
                        {!postsLoading && POSTS.length === 0 && (
                            <p style={{ padding: "1rem", color: "var(--text-sub)" }}>No posts yet.</p>
                        )}
                        {POSTS.map((post) => (
