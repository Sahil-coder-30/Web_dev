...
// DS §6: LEFT SIDEBAR — .sidebar__* canonical classes
// Profile version: Profile item is active, Home item links back
const DesktopSidebar = ({ currentUser }) => {
    ...
    return (
        <aside className="sidebar">
            {/* Logo — Grand Hotel + IG gradient via .navbar__wordmark */}
